...
namespace ur_kinematics {
  ...
  void forward(const double* q, double* T) {  //introduction-to-robotics-analysis-control-applications.pdf (2.59)
  ...
  //introduction-to-robotics-analysis-control-applications.pdf (2.53)
  //https://zhuanlan.zhihu.com/p/139293296
