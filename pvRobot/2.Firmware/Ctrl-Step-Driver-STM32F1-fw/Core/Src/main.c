...
static void MX_TIM1_Init(void)
{
  ...
  htim1.Init.ClockDivision = TIM_CLOCKDIVISION_DIV2; //TIM_CLOCKDIVISION_DIV1
...
static void MX_TIM2_Init(void)
{
  ...
  htim2.Init.ClockDivision = TIM_CLOCKDIVISION_DIV2; //TIM_CLOCKDIVISION_DIV1
...
static void MX_TIM3_Init(void)
{
  ...
  htim3.Init.ClockDivision = TIM_CLOCKDIVISION_DIV2; //TIM_CLOCKDIVISION_DIV1
...
static void MX_TIM4_Init(void)
{
  ...
  htim4.Init.ClockDivision = TIM_CLOCKDIVISION_DIV2; //TIM_CLOCKDIVISION_DIV1
